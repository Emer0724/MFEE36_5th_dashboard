...
<div class="container-full ">
  ...
  <div class="row mt-5">
    <div class="col-6 ">
      <form action="uesd_add.php" method="get" class="ms-2">
    ...
    <table class="table">
      <thead>
        <tr>
          ...
          <th scope="col" class='text-center '>會員編碼</th>
      ...
      <tbody>
        <?php foreach ($stmt as $r) : ?>
          <tr>
            ...
            <td scope="col" class='text-center'><a href="used_edit.php?sid=<?= $r['serial_id'] ?>"><i class="fa-solid fa-pen-to-square fs-4"></i></a></td>
          </tr>
        <?php endforeach; ?>
