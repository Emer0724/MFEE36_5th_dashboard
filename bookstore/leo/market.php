    ...
    <div class="container ">
        <div class="row">
            <table data-toggle="table" data-sortable="true" data-sort-class="table-active" data-pagination="true" data-search="true" data-show-search-clear-button="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-show-columns-toggle-all="true" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th scope="col" data-sortable="true">ISBN</th>
                        <th scope="col" data-sortable="true">書名</th>
                        <th scope="col" data-sortable="true">照片</th>
                        <th scope="col" data-sortable="true">作者</th>
                        <th scope="col" data-sortable="true">出版社</th>
                        <th scope="col" data-sortable="true">售價</th>
                        <th scope="col" data-sortable="true">進價</th>
                ...
                <tbody>
                    <?php foreach ($rows as $r) : ?>
                        <tr>
                            ...
                            <td><a href="market-edit.php?ISBN=<?= $r['ISBN'] ?>">
