...
if ($totalRows) {
    ...
    $sql = sprintf("SELECT * FROM coupon ORDER BY couponID DESC LIMIT %s, %s", ($page - 1) * $perPage, $perPage);
            ...
            <table data-toggle="table" data-sortable="true" data-sort-class="table-active" data-pagination="true" data-search="true" data-show-search-clear-button="true" data-show-refresh="true" data-show-toggle="true" data-show-columns="true" data-show-columns-toggle-all="true" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col" data-sortable="true">開始日期</th>
                        <th scope="col" data-sortable="true">結束日期</th>
                ...
                <tbody>
                    <?php foreach ($rows as $r) : ?>
                        <tr>
                            ...
                            <td><?= $r['start'] ?></td>
                            <td><?= $r['end'] ?></td>
                            <td><a href="coupon-edit.php?couponID=<?= $r['couponID'] ?>">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>
                            </td>
                            <td><a href="javascript: delete_it(<?= $r['couponID'] ?>)">
