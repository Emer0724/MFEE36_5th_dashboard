...
$sql = "SELECT *FROM coupon WHERE couponID={$couponID}";
...
<nav class="navbar navbar-main navbar-expand-lg px-0  mx-4 shadow-none border-radius-xl " id="navbarBlur" data-scroll="true">
    <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
            ...
            <h6 class="font-weight-bolder mb-0">優惠券編輯</h6>
        </nav>
    ...
    <div class="row">
        <div class="col-6">
            <div class="card">
                ...
                <div class="card-body">
                    <h5 class="card-title">編輯優惠券資料</h5>
                    <form name="form_coupon" onsubmit="checkForm(event)">
                        <input type="hidden" name="sid" value="<?= $r['couponID'] ?>" readonly>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="amount" class="form-label">折扣金額</label>
                            <input type="text" class="form-control" id="amount" name="amount" value="<?= htmlentities($r['amount']) ?>" data-required="1">
                            <div class="form-text"></div>
                        </div>
                        <div class="mb-3">
                            <label for="start" class="form-label">開始日期</label>
                            <input type="date" class="form-control" id="start" name="start" value="<?= htmlentities($r['start']) ?>" data-required="1">
                            <div class="form-text"></div>
                        </div>
                        <div class="mb-3">
                            <label for="end" class="form-label">結束日期</label>
                            <input type="date" class="form-control" id="end" name="end" value="<?= htmlentities($r['end']) ?>">
                            <div class="form-text"></div>
                        </div>
